...
router.post("/", isLoggedIn, isAdmin, isSafe, function(req, res){
...
// hardcoded values below to bypass registering and getting geocoder API key as they want credit card
...
router.get("/:id/edit", isLoggedIn, isAdmin, checkUserCampground, function(req, res){
